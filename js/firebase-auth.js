/* ═══════════════════════════════════════════════════════════════════
   ...
   - Account deletion: still needs the server-side Cloud Function from
     the earlier sync-layer doc — client-side Firebase Auth deletion
     alone can't also clean up Supabase profile data safely.
   ═══════════════════════════════════════════════════════════════════ */
