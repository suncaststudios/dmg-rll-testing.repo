...
const THEME_SIGILS = {
    ...
    /* Angelic — plain, minimal ring in soft gold, halo-like */
    angelic: {
        outer: `
            <circle cx="160" cy="160" r="150" stroke="rgba(201,162,39,0.3)" stroke-width="1"/>
            <circle cx="160" cy="160" r="145" stroke="rgba(201,162,39,0.18)" stroke-width="0.5"/>`,
        inner: `
            <circle cx="120" cy="120" r="100" stroke="rgba(201,162,39,0.3)" stroke-width="1"/>
            <circle cx="120" cy="120" r="18" stroke="rgba(201,162,39,0.5)" stroke-width="1.5"/>`,
    },
